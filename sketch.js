...
var ground;
var plant, plantimg;
var spikes, spike2, spike3, spikeimg;
...
plant = createSprite(40,351,11,11);
plant.addImage("plant", plantimg)
plant.scale = 1/2
ground1.addImage("imag", groundimg);
spikes = createSprite(394,175, 11, 11);
spike2 = createSprite(301,771, 11, 11);
spike3 = createSprite(703,362, 11, 11);
spike2.addImage("spiky", spikeimg);
spikes.addImage("spiky", spikeimg);
spike3.addImage("spiky", spikeimg);
spikes.scale = 1/4;
spike2.scale = 1/4;
spike3.scale = 1/4;
if(player.isTouching(spikes) || player.isTouching(spike2)|| player.isTouching(spike3)|| player.isTouching(plant)){
  player.destroy();
}
     ground1.scale = 1/2;
    // ground1.debug = true;
